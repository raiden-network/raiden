...
def stun_socket(socket, source_ip="0.0.0.0", source_port=4200, stun_host=None, stun_port=3478):
    ...
    nat_type, nat = stun.get_nat_type(
        socket, source_ip, source_port, stun_host=stun_host, stun_port=stun_port
    )
