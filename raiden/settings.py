...
# it's an approximation because the settlement and reveal timeouts may vary
DEFAULT_APPROXIMATE_MAXIMUN_NUMBER_HOPS = 20

DEFAULT_REVEAL_TIMEOUT = 30
DEFAULT_SETTLE_TIMEOUT = DEFAULT_REVEAL_TIMEOUT * DEFAULT_APPROXIMATE_MAXIMUN_NUMBER_HOPS
DEFAULT_MINIMUM_SETTLE_TIMEOUT = DEFAULT_REVEAL_TIMEOUT * 5
DEFAULT_MAXIMUM_SETTLE_TIMEOUT = DEFAULT_SETTLE_TIMEOUT * 10
