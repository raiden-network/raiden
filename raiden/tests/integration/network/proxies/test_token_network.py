...
def test_token_network_proxy(
    ...
    msg = (
        'Zero is not a valid channel_identifier identifier, ValueError must be '
        'raised.'
    )
    ...
    msg = (
        "Trying a deposit to an inexisting channel must fail."
    )
    ...
    msg = (
        "Trying to close an inexisting channel must fail."
    )
