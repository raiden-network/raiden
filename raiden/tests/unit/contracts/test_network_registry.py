...
@pytest.fixture
def get_random_address(get_random_bytes):
    return lambda: get_random_bytes(20)


def test_network_registry(token_network_registry_proxy, get_random_address, deploy_token):
    bad_token_address = get_random_address()
