...
def test_routing_issue2663(chain_state, token_network_state, one_to_n_address, our_address):
    ...
    assert routes1[0].next_node == address1
    assert routes1[1].next_node == address2
    ...
    assert routes1[0].next_node == address2
...
def test_routing_priority(chain_state, token_network_state, one_to_n_address, our_address):
    ...
    assert routes[0].next_node == address1
    assert routes[1].next_node == address2
    ...
    assert routes[0].next_node == address2
    assert routes[1].next_node == address1
