...
UNIT_TRANSFER_INITIATOR = typing.Address(b'initiatorinitiatorin')
UNIT_TRANSFER_TARGET = typing.Address(b'targettargettargetta')
...
UNIT_CHAIN_ID = 337
ADDR = typing.Address(b'addraddraddraddraddr')
