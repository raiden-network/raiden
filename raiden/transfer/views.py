...
def get_payment_network_address(chain_state: ChainState) -> List[TokenNetworkRegistryAddress]:
...
def get_token_network_addresses(
    chain_state: ChainState, payment_network_address: TokenNetworkRegistryAddress
