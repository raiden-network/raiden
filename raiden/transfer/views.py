...
def all_neighbour_nodes(node_state):
...
def get_networkstatuses(node_state):
    return node_state.nodeaddresses_to_networkstates


def get_node_network_status(node_state, node_address):
...
def get_token_network_addresses_for(node_state, payment_network_id):
...
def total_token_network_channels(node_state, payment_network_id, token_network_id):
...
def get_channelstate_for(node_state, payment_network_id, token_network_id, partner_address):
...
def get_channelstate_by_id(node_state, payment_network_id, token_network_id, channel_id):
    token_network = get_token_network(
        node_state,
        payment_network_id,
        token_network_id,
...
def get_channestate_for_receiving(node_state, payment_network_id, token_network_id):
...
def get_channelstate_open(node_state, payment_network_id, token_network_id):
...
def get_channelstate_not_settled(node_state, payment_network_id, token_network_id):
    """Return the state of open channels in a token network."""
    token_network = get_token_network(
        node_state,
        payment_network_id,
...
def get_channelstate_by_tokenaddress(node_state, payment_network_id, token_network_id, channel_id):
    token_network = get_token_network(
        node_state,
        payment_network_id,
        token_network_id,
...
def get_transfer_role(node_state, hashlock):
...
def list_channelstate_for_tokennetwork(node_state, payment_network_id, token_network_id):
    token_network = get_token_network(
        node_state,
        payment_network_id,
        token_network_id,
...
def list_channelstate_for_partner(node_state, payment_network_id, partner_address):
    payment_network = node_state.identifiers_to_paymentnetworks.get(payment_network_id)
...
def list_all_channelstate(node_state):
    result = []
    for payment_network in node_state.identifiers_to_paymentnetworks.values():
        for token_network in payment_network.tokenaddresses_to_tokennetworks.values():
            # TODO: Either enforce immutability or make a copy
...
def search_for_channel(node_state, payment_network_id, channel_address):
    payment_network = node_state.identifiers_to_paymentnetworks.get(payment_network_id)
