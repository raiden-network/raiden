...
- You need to make sure that your system has ``solc``, the ethereum solidity compiler installed. Refer to `its documentation`_ for the installation steps. (Note: It is possible to use Raiden without solc because every official realease brings precompiled smartcontracts)
