...
@click.command()
@click.option(
    "--results-dir", required=True, help="Directory with output json files from orchestration run."
)
...
def process_results(results_dir, plot_filename):
    ...
    for filename in os.listdir(results_dir):
        ...
        if "timestamps" in contents:
            ...
            print(
                "Node {} sent messages from {} to {}".format(
                    filename,
    ...
    print("First transfer was at {}".format(datetime.fromtimestamp(min_).strftime("%H:%M:%S.%f")))
    print("Last transfer was at {}".format(datetime.fromtimestamp(max_).strftime("%H:%M:%S.%f")))
    ...
    for time in range(initial_time, last_time):
        ...
        print(
            "Total transfers from {} to {} was {}".format(
    ...
    print(
        "Maximum transfers happened from {} to {} and was {}".format(
